...
<body>
            ...
            <div class="col-9 ">
                ...
                <a href="addproduct.php" class="btn btn-dark"><i class="fa-solid fa-plus pe-2"></i>Add products</a>
                <hr>
                ...
                <?php
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td>
                                <form action="updateproduct.php" method="POST" class="d-inline">
                            ...
                            <?php 
                                if (isset($_POST['delete'])) {
                                    $sql = "DELETE FROM product WHERE product_id = ".$_POST["pid"];  
